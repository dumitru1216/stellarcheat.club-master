...
namespace SDK
{
	...
	public:
		...
		void DrawSetTextureRGBA(int id, const unsigned char *rgba, int wide, int tall)
		{
			...
			return ((Fn)VMT::VMTHookManager::GetFunction<Fn>(this, 37))(this, id, rgba, wide, tall);
		}
		...
		{
			float r, g, b, a;
			r = col.RGBA[0];g = col.RGBA[1];b = col.RGBA[2];a = col.RGBA[3];
		...
		{
			float r, g, b, a;
			r = Color.RGBA[0]; g = Color.RGBA[1]; b = Color.RGBA[2]; a = Color.RGBA[3];
			typedef void(__thiscall* Fn)(void*, int, int, int, int);
			return ((Fn)VMT::VMTHookManager::GetFunction<Fn>(this, 25))(this, r, g, b, a);
		}
