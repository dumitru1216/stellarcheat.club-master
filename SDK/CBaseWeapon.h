...
namespace SDK
{
	...
	public:
		...
		int GetOwnerWep()
		{
			return *(int*)((uintptr_t)this + OFFSETS::m_hOwnerWep);
		}
		int* ModelIndex()
		{
		...
		float GetSpreadCone()
		{
			...
			return VMT::VMTHookManager::GetFunction<Fn>(this, 449)(this);
		}
		float GetInaccuracy()
		{
			typedef float(__thiscall* Fn)(void*);
			return VMT::VMTHookManager::GetFunction<Fn>(this, 479)(this); //469
		}
		...
		bool is_m4a1()
		{
			SDK::definition_index::WEAPON_M4A1;
		}
		bool is_knife()
		{
			int iWeaponID = this->GetItemDefenitionIndex();
		...
		void UpdateAccuracyPenalty()
		{
			...
			return VMT::VMTHookManager::GetFunction<Fn>(this, 480)(this); //470
		}
		...
		Weapon_Info* GetWeaponInfo()
		{
			...
			return VMT::VMTHookManager::GetFunction<Fn>(this, 457)(this);
		}
