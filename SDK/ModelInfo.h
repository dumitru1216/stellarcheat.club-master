...
struct studiohdr_t
{
	...
	int	attachmGetIndex;
	inline void	*pAttachment(int i) const { return (((byte *)this) + attachmGetIndex) + i; };
	...
	public:
		...
		virtual void					GetModelMaterialColarAndLighting(const model_t *model, Vector const& origin,
