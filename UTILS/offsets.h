...
namespace OFFSETS
{
	...
	extern uintptr_t m_flHealthShotBoostExpirationTime;
	extern uintptr_t m_hOwner;
	extern uintptr_t m_hOwnerWep;
	extern uintptr_t m_hOwnerEnt;
	...
	extern uintptr_t m_fduckamount;
	extern uintptr_t m_fduckspeed;
	void InitOffsets();
}