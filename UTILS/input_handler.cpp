...
namespace UTILS
{
	namespace INPUT
	{
		...
		int InputHandler::keyBindings(int setting)
		{
			...
			case 54: vk = VK_CONTROL; break;
			case 55: vk = VK_MENU; break;
			case 56: vk = VK_SHIFT; break;
			case 57: vk = 0x25; break;
			case 58: vk = 0x26; break;
			case 59: vk = 0x27; break;
			case 60: vk = 0x28; break;
			default: break;
			}
			return vk;
		}
