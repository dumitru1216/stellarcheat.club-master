...
namespace OFFSETS
{
	...
	uintptr_t m_flHealthShotBoostExpirationTime;
	uintptr_t m_iMatchStats_PlayersAlive_CT;
	uintptr_t m_fduckamount;
	uintptr_t m_fduckspeed;
	uintptr_t m_hOwnerEnt;
	uintptr_t m_hOwnerWep;
	...
	//	INTERFACES::Engine->ExecuteClientCmd("clear");
		...
		m_hOwnerWep = UTILS::netvar_hook_manager.GetOffset(("DT_BaseCombatWeapon"), ("m_hOwner"));
		m_hOwnerEnt = UTILS::netvar_hook_manager.GetOffset(("DT_CSPlayer"), ("m_hOwnerEntity"));
		...
		m_fduckamount = UTILS::netvar_hook_manager.GetOffset(("DT_CSPlayer"), ("m_flDuckAmount"));
		m_fduckspeed = UTILS::netvar_hook_manager.GetOffset(("DT_CSPlayer"), ("m_flDuckSpeed"));
		...
		m_iClip2 = UTILS::netvar_hook_manager.GetOffset("DT_BaseCombatWeapon", "m_iPrimaryReserveAmmoCount");
		get_ragdoll_pos = UTILS::netvar_hook_manager.GetOffset("DT_Ragdoll", "m_ragPos");
		m_flHealthShotBoostExpirationTime = UTILS::netvar_hook_manager.GetOffset("DT_CSPlayer", "m_flHealthShotBoostExpirationTime");
		...
		m_nExplodeEffectTickBegin = UTILS::netvar_hook_manager.GetOffset(("DT_BaseCSGrenadeProjectile"), ("m_nExplodeEffectTickBegin"));
		m_bDormant = 0xED;
		animstate = 0x3900;
