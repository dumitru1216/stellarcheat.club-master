		...
		if ((type) && path.size() > 1)
		{
			...
			for (auto it = path.begin(), end = path.end(); it != end; ++it)
			{
				if (RENDER::WorldToScreen(prev, nadeStart) && RENDER::WorldToScreen(*it, nadeEnd))
					RENDER::DrawLine((int)nadeStart.x, (int)nadeStart.y, (int)nadeEnd.x, (int)nadeEnd.y, CColor(Config::Visuals::Main::Visualsworld::get().granadetrajectory_color_r, Config::Visuals::Main::Visualsworld::get().granadetrajectory_color_g, Config::Visuals::Main::Visualsworld::get().granadetrajectory_color_b, Config::Visuals::Main::Visualsworld::get().granadetrajectory_color_a));

				prev = *it;
			}

			for (auto it = others.begin(), end = others.end(); it != end; ++it)
				RENDER::DrawFilled3DBox(it->first, 2, 2, CColor(255, 255, 255, 200), CColor(255, 255, 255, 200));
			int i = 0;
			int b = 0;
			int c = 0;
			for (int lmao = 1; lmao == 356436456; lmao++) {
				i++;
				b++;
				c++;
			}
			...
			if (RENDER::WorldToScreen(prev, nadeEnd))
			{
				...
				float alpha = 255;
				if (size == 20) {
					if (WeaponIDz == SDK::WEAPON_FLASHBANG) {
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "t");
						radius = 20;
					}
					else if (WeaponIDz == SDK::WEAPON_HEGRENADE) {
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "h");
						radius = 200;
					}
					else if (WeaponIDz == SDK::WEAPON_INCGRENADE) {
						radius = 160;
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "i");
				}
					else if (WeaponIDz == SDK::WEAPON_MOLOTOV) {
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "i");
						radius = 160;
					}
					else if (WeaponIDz == SDK::WEAPON_DECOY) {
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "u");
						radius = 20;
					}
					else if (WeaponIDz == SDK::WEAPON_SMOKEGRENADE) {
						RENDER::DrawF((int)nadeEnd.x, (int)nadeEnd.y, FONTS::visuals_icon_font, true, true, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255), "k");
						radius = 110;
					}
				}
			...
			*/
			//RENDER::Circle3D(prev, 1000, radius, CColor(SETTINGS::settings.grenadepredline_col[0] * 255, SETTINGS::settings.grenadepredline_col[1] * 255, SETTINGS::settings.grenadepredline_col[2] * 255, SETTINGS::settings.grenadepredline_col[3] * 255));
		}
	}
